...
**12개의 연구실에서 매일의 날씨에 관한 연구 뿐만 아니라 과거에서 미래로 이어지는 지구의 기후에 관한 연구가 동시에 진행되고 있으며,
...
대기복사연구실은 지구-대기-우주 시스템에서의 복사에너지 전달과 이를 활용한 대기환경 관측 및 원격탐사에 관한 기초·응용연구를 수행하고 있습니다. 복사에너지의 지상 및 위성 관측, 이론적 복사전달과정의 해석과 계산을 기반으로 대기오염물질과 온실가스의 정량적 관측 및 대기환경 원격탐사 (remote sensing) 기술을 개발하고 있습니다. 최근에는 인공지능(AI)과 빅데이터를 활용한 위성 원격탐사 알고리즘 개발과 위성관측자료를 이용한 대기오염물질의 하향식 (Top-down) 배출량 산정 등으로 연구 영역을 확장하고 있습니다. 또한 다양한 복사계와 분광광도계를 활용한 지상 관측을 수행하며, NASA를 비롯한 국제 관측 네트워크와의 협력을 통해 대기환경 변화에 대한 정밀한 관측과 과학적 이해를 추구하고 있습니다.

<br>

#### 대기예측성 및 자료동화 연구실(김현미 교수님) [(http://apdal.yonsei.ac.kr)](https://apdal.yonsei.ac.kr)

대기예측성 및 자료동화연구실 (APDAL)에서는 날씨 예보에 많은 영향을 주는 수치예측의 정확도를 향상시키기 위해 수치모델 및 자료동화시스템에 관련된 연구를 수행하며, 이러한 연구들을 바탕으로 대기의 본질적인 예측성을 이해하고자 합니다. 수치예측의 전반적인 과정을 다루는 연구실로, 중위도 기상과 극지 기상, 탄소 순환, 대기 화합물 (미세먼지) 등 대기과학의 다양한 분야에서 수치 모델링, 자료동화 및 딥러닝을 사용한 예측, 진단 연구를 수행하고 있습니다. 
...
대기모형연구실에서는 대기 내 복잡한 역학 과정을 정교하게 구현할 수 있도록 대기 모형의 한계를 극복하고 예측 성능을 개선하는 연구를 수행합니다. 실제 대기의 필수적인 역학적 특성을 정확히 모사하는 것이 핵심 과제인 만큼, 본 연구실은 혁신적인 접근 방식을 다각도로 도입하여 대기 모형 기술의 한계를 지속적으로 넓혀가고 있습니다. 연구실의 목표는 대기 모형의 이론적 한계를 넓힐 뿐만 아니라, 이러한 연구 성과를 바탕으로 대기과학 분야의 발전을 이끌고 사회에 실질적인 이익을 가져다줄 수 있는 실용적인 예보 도구로 구현해 내는 것입니다.
